  ...
  features {
    ...
    python {
      on :dependencies do |package|
        package.dependencies << 'development/interpreters/python.2'
      end
    ...
    python3 {
      on :dependencies do |package|
        package.dependencies << 'development/interpreters/python.3'
      end
    ...
    cscope {
      on :dependencies do |package|
        package.dependencies << 'development/utilities/cscope'
      end
    }
